...
import require$$2, { join, dirname } from 'path';
import require$$3, { existsSync, readFileSync, writeFileSync } from 'fs';
import require$$4 from 'process';
import require$$0$1 from 'util';
import require$$3$1 from 'os';
import require$$4$1 from 'tty';
...
function getEntryFileContent(filename = EntryFileName) {
  ...
  if (!existsSync(entryPath)) {
    let entryPath2 = join(cwd, "src", filename);
    if (!existsSync(entryPath2)) {
      entryPath2 = null;
